...
String project= request.getParameter("hobbies7");
  ...
  try{
	  String query= String.format("insert into SEPM(username,submitted_1,submitted_2,submitted_3,submitted_4,submitted_5,submitted_6,project) values('"+name+"','"+submitted_1+"','"+submitted_2+"','"+submitted_3+"','"+submitted_4+"','"+submitted_5+"','"+submitted_6+"','"+project+"')");
