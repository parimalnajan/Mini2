...
<section class="container">
    <div class="login">
      <h1>Assignments for ISEE</h1>
                  <form name="iseeFrm" action="donePage4.jsp" method="post">
...
<!--                 To submit for second time <input type="submit" name="sub" value="Update" onclick="window.location='updtassi4.jsp'" >
 -->     
            </center>
</body>
</html>