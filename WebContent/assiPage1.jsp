...
<section class="container">
    <div class="login">
      <h1>Theory of Computations</h1>
<form name ="toc1Frm" action="yesPage.jsp" method="post" >     
      <p><select name="Name"><br>
        <option>Select Name</option>
                   <%
                        ...
                        stmt=con.prepareStatement("Select username from TOC");
                        ResultSet rst2=stmt.executeQuery("Select * from TOC");
                        while(rst2.next())
                       {
                   %>
