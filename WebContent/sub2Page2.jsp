...
<section class="container">
    <div class="login">
      <h1>Assignments for DBMS</h1>
            <form name="dbmsFrm" action="donePage2.jsp" method="post">
...
<!--                       To submit for second time <input type="submit" name="sub" value="Update" onclick="window.location='updtassi2.jsp'" >
 -->           
            </center>
</body>
</html>