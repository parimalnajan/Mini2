...
<section class="container">
	...
	<% 	    
	 String driver= "com.mysql.jdbc.Driver";
	  ...
	  String password= request.getParameter("password");
	    ...
	    try{
	  	  String query= String.format("insert into registration1(name,mobile,email,username,password) values('"+name+"','"+mobile+"','"+email+"','"+username+"','"+password+"')");
	 ...
	 %>
	    		...
	    		<br><br><a href="http://localhost:8080/SMSWebApp1/registrationPage.jsp"><b>TRY AGAIN.</b></a> Username taken.<br><br>
    ...
    Password entered :<%=request.getParameter("password")%><br>
      ...
      %>
      Please LogIn<input type="button" name="login" value="Login" onclick="window.location='login1Page.jsp'">
