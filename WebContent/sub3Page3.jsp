...
<section class="container">
    <div class="login">
      <h1>Assignments for SEPM</h1>
            <form name="sepmFrm" action="donePage3.jsp" method="post">
...
<!--                       To submit for second time <input type="submit" name="sub" value="Update" onclick="window.location='updtassi3.jsp'">
 -->           
            </center>
</body>
</html>