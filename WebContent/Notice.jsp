...
<section class="container">
    <div class="login">
      <h1>Upload Confirmation</h1>
      	<form action = "uploadPage1.jsp" method="post">
      
<p>	Due Date(dd/mm/yyyy) : <input type = "date" name = "duedate"/>
		<p>	Description :<textarea rows="3" cols="50" name="description1"></textarea>
		<p>	Attachment : <input type = "file" name = "attachment">
