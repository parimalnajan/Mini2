...
<section class="container">
    <div class="login">
      <h1>Assignments for CN</h1>
                  <form name="cnFrm" action="donePage5.jsp" method="post">
...
<!--                       To submit for second time <input type="submit" name="sub" value="Update" onclick="window.location='updtassi5.jsp'">
 -->           
            </center>
</body>
</html>