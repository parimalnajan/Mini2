...
<section class="container">
	...
	<% 	    
	 String driver= "com.mysql.jdbc.Driver";
	  ...
	  String attachment= request.getParameter("attachment");
	    ...
	    try{
	  	  String query= String.format("insert into assignments(assignmentID,subject,startdate,duedate,description,title) values('"+assignmentID+"','"+subject+"','"+startdate+"','"+duedate+"','"+description+"','"+title+"')");
 ...
 %>
 <input type="submit" value="Back" onclick="window.location='welcomePage.jsp'">
</body>
</html>